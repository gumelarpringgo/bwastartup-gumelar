...
func (h *campaignHandler) GetCampaigns(c *gin.Context) {
	...
	response := helper.APIResponse("List off campaigns", http.StatusOK, "success", campaign.FormatCampaigns(campaigns))
...
func (h *campaignHandler) GetCampaign(c *gin.Context) {
	...
	// api/v1/campaigns/1(ID campaign)
...
func (h *campaignHandler) UpdateCampaign(c *gin.Context) {
	...
	// handler
	//mapping dari input ke input struct (ada dua => dari uri dan user)
	// input dari user, dan juga input yang ada di uri (passing ke service)
	// service (membutuhkan parameter) => find campaign by id, tangkap parameter
...
func (h *campaignHandler) UploadImage(c *gin.Context) {
	...
	respone := helper.APIResponse("Campaign image successfuly uploaded", http.StatusOK, "success", data)

	c.JSON(http.StatusOK, respone)

	// handler
	// tangkap input dan ubar ke struct input
