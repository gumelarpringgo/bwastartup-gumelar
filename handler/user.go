...
func (h *userHandler) RegisterUser(c *gin.Context) {
	...
	// struct di atas kita pasang sebagai parameter service
...
func (h *userHandler) CheckEmailAvailability(c *gin.Context) {
	...
	// service memanggil repository - ada tidaknya email
...
func (h *userHandler) UploadAvatar(c *gin.Context) {
	// tangkap input dari user
	// simpan gamabar di folder "images/"
	...
	// repository mengupdate data user, simpan lokasi file
	...
	// images/namafile.png => yang lama
	// images/userid-namafile.png => yang baru
